    ...
    <div className="py-16 bg-gray-50" id="compare">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h2 className="text-3xl font-bold text-gray-900">Compare Solar Products</h2>
          <p className="mt-4 text-lg text-gray-600">Find the perfect solar solution for your needs</p>
        </div>
          ...
          {products.map((product, index) => (
            <div key={index} className="bg-white rounded-lg shadow-lg overflow-hidden">
              <div className="px-6 py-8">
                ...
                <p className="mt-4 text-center text-gray-500">Type: {product.type}</p>
                <p className="text-center text-gray-500">Efficiency: {product.efficiency}</p>
                <p className="text-center text-gray-500">Warranty: {product.warranty}</p>
